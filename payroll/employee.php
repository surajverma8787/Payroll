...
tr:nth-child(even){background-color: #F7F2E7;}
tr:nth-child(odd){background-color: #D8D3CD;}
...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          <img src="images/employee.jpg" alt="Lights" style="width:100%" style="height: 170px">
